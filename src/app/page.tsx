    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            LearnPath helps developers plan, track, and complete their learning roadmaps.
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-3xl text-center rounded-2xl border bg-gradient-to-b from-primary/10 to-transparent p-12">
          ...
          <p className="mt-3 text-muted-foreground">
            Join developers who are learning smarter and tracking their progress with LearnPath.
          </p>
          <Link href="/register">
      ...
      <footer className="border-t py-8 px-6">
        <div className="mx-auto max-w-6xl flex items-center justify-between text-sm text-muted-foreground">
          <p>© 2026 LearnPath. Built by Raditya Ahmad.</p>
