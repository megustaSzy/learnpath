      ...
      `}>
        <div className="flex h-16 items-center justify-between px-5 border-b border-white/5">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight">LearnPathX</span>
          </Link>
        ...
        <div className="border-t border-white/5 p-3">
          ...
          <Dialog open={logoutOpen} onOpenChange={setLogoutOpen}>
            <DialogContent>
              ...
              <p className="text-sm text-muted-foreground">Are you sure you want to log out from LearnPathX?</p>
